...
export function StudioFooter({ locale }: { locale: string }) {
    const scrollToTop = () => {
    ...
    return (
        ...
        >
            {/* Máscara absoluta para evitar pulos no Safari iOS */}
            <div 
...
whileInView="show"
                ...
                >
                    ...
                    >
                        <span className="text-step--2 type-label text-foreground/70 mb-1">Email:</span>
                    ...
                    >
                        <span className="text-step--2 type-label text-foreground/70 mb-1">WhatsApp:</span>
                        <span className="text-step-1 md:text-step-2 font-bold text-foreground flex items-center gap-4 relative">
                            <span className="relative">
                                +55 21 99937-4516
                                <span className="absolute -bottom-1 left-0 w-full h-px bg-current scale-x-0 origin-right transition-transform duration-300 group-hover:scale-x-100 group-hover:origin-left"></span>
