...
function FloatingSVG({
    ...
    src: string, top: string, left: string, scale: number, width: string, index: number, scrollYProgress: MotionValue<number>, isMobile: boolean
}) {
    ...
    let blurPx = scale < 1.0 ? (1.0 - scale) * 8 : (scale - 1.0) * 4;
    // Safari de iPhone (WebKit) odeia blur em elementos móveis. Desativar no mobile:
    if (isMobile) blurPx = 0;
...
export function IntermissionSVGs() {
    ...
    // Suaviza os "pulos" (ticks) da rodinha do mouse no Desktop.
    // No Mobile, usar direto o scrollYProgress evita engasgos da Main Thread calculando físicas spring.
    ...
    const floatingItems = [
        // Layer 1 (Top)
        { src: "/images/approach-anima/19-CRFmug.svg/", top: "5%", left: "10%", width: "16%", scale: 1.2 },
        { src: "/images/approach-anima/11-quest3.svg", top: "15%", left: "45%", width: "15%", scale: 0.8 },
        { src: "/images/approach-anima/14-ipad.svg", top: "10%", left: "80%", width: "20%", scale: 1.4 },

        // Layer 2 (Mid-Top)
        { src: "/images/approach-anima/15-steamdeck.svg", top: "35%", left: "20%", width: "18%", scale: 0.6 },
        { src: "/images/approach-anima/12-macbook.svg", top: "25%", left: "60%", width: "12%", scale: 0.8 },
        { src: "/images/approach-anima/17-rings.svg", top: "30%", left: "90%", width: "12%", scale: 0.7 },
        ...
        { src: "/images/approach-anima/06-AI.svg", top: "45%", left: "75%", width: "18%", scale: 1.3 },

        // Layer 4 (Mid-Bottom)
        { src: "/images/approach-anima/16-saw.svg", top: "70%", left: "30%", width: "15%", scale: 0.5 },
        { src: "/images/approach-anima/13-iphone.svg", top: "75%", left: "65%", width: "14%", scale: 0.9 },
        { src: "/images/approach-anima/05-wireframe.svg", top: "80%", left: "95%", width: "16%", scale: 1.5 },

        // Layer 5 (Bottom)
        { src: "/images/approach-anima/18-guittar.svg", top: "90%", left: "10%", width: "18%", scale: 0.6 },
        { src: "/images/approach-anima/20-Kindle.svg", top: "95%", left: "45%", width: "15%", scale: 1.1 },
        { src: "/images/approach-anima/04-pentool.svg", top: "85%", left: "85%", width: "14%", scale: 0.8 },
    ];
            ...
            <div className="absolute inset-0 w-full h-full pointer-events-none z-10">
                {floatingItems.map((item, i) => (
                    <FloatingSVG
                        ...
                        top={item.top}
                        left={item.left}
                        scale={isMobile ? item.scale * 1.6 : item.scale}
                        width={item.width}
