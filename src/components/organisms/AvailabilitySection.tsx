            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-foreground border border-foreground w-full">
                {data.blocks.map((block, i) => (
                    <motion.div 
                        ...
                        className="group bg-background hover:bg-halftone transition-all duration-500 p-fluid-2xl flex flex-col items-start overflow-hidden relative cursor-crosshair h-full"
                    >
                        ...
                        <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] w-full z-10">
                            <div className="overflow-hidden">
                                <p className="text-step-0 text-foreground font-light leading-relaxed max-w-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 delay-100">
                                    {block.description}
                                </p>
